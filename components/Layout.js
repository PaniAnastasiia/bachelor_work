...
export default function Layout({ children, title }) {
    ...
    return (
      <>
        ...
        >
          ...
          />
          <button
            className="rounded rounded-tl-none rounded-bl-none bg-violet-300 p-1 text-sm dark:text-black"
            type="submit"
            id="button-addon2"
          >
        ...
        {status === 'loading' ? (
          ...
          <Menu as="div" className="relative inline-block">
            <Menu.Button className="text-violet-600">
              {session.user.name}
            </Menu.Button>
            <Menu.Items className="absolute right-0 w-56 origin-top-right   bg-white shadow-lg   dark:bg-black dark:shadow-gray-700 z-40">
              <Menu.Item>
  ...
  return (
    <>
      <Head>
        <title>{title ? title : 'eStore'}</title>
        <meta name="description" content="eStore Website" />
        ...
        <div>
          ...
          >
            <div className="flex items-center">
              ...
              >
                <MenuIcon className="h-5 w-5 text-violet-600"></MenuIcon>
              </div>
              <Link href="/">
            ...
            <div className="cursor-pointer px-4 md:hidden" onClick={toggle}>
              <DotsVerticalIcon className="h-5 w-5 text-violet-600"></DotsVerticalIcon>
            </div>
          ...
          <div
            className={`fixed top-0 left-0 z-40 h-full w-[20rem] bg-gray-100 p-10 duration-300  ease-in-out dark:bg-gray-800 ${
